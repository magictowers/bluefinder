...
CREATE TABLE `NFPC` (`id` int(3) NOT NULL AUTO_INCREMENT, `v_from` varchar(800) NOT NULL, `u_to` varchar(800) NOT NULL, PRIMARY KEY (`id`)) ENGINE=MyISAM AUTO_INCREMENT=1 DEFAULT CHARSET=utf8;
