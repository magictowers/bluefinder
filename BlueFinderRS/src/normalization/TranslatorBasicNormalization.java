...
public class TranslatorBasicNormalization extends BasicNormalization implements INormalizator {
    ...
    private String getTranslatedName(String pageName, int pageNamespace){
    	...
    	try {
			...
			String query = "SELECT CONVERT(ll_title USING utf8) as ll_title FROM langlinks as lan inner join page on page_title=? and page_namespace="+pageNamespace+" and page_id=lan.ll_from and ll_lang='"+this.languageToTranslate+"'";
